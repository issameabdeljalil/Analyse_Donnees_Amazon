## Prérequis ------------------------------------------------------------------------------------
Avant de lancer le programme, le module deep_translator doit être installé. Celui-ci permet
le bon fonctionnement du programme et doit être utilisé avec une connexion internet.

# Lancement des programmes ---------------------------------------------------------------------
Les différents scripts doivent être lancé depuis le dossier Scripts (en tant que répertoire de travail).

# Configuration du Raccourci Rapide ------------------------------------------------------------
Pour utiliser le raccourci rapide ("Amazon Smart Research"), le chemin inscrit dans le fichier 
...
Data/raw : données de base (supprimées du dossier car trop lourdes pour github)
Data/out : données modifiées (supprimées du dossier car trop lourdes pour github)
