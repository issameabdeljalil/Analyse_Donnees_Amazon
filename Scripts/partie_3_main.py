# -*- coding: utf-8 -*-
"""
Partie 3 : MAIN (Interface Tkinter)
...
Partie 3 : Interface graphique sous Tkinter
Objectif : Rechercher des produits correspondants aux choix de selection de l'utilisateur
Cette interface devra comporter les éléments suivants:
- Possibilité pour l’utilisateur de saisir les différents critères 
...
from partie_3_fonctions import rechercher # derniere fonction de notre module
